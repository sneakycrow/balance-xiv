...
qna:
  ...
  - question: Why is hardcast Holy Spirit not really 350 potency?
    answer:
      PLD auto-attacks are normalized to 90p every 3s, so with a 1 second cast
  ...
  - question: What GCD speed should I use?
    answer:
      2.50 is ideal (see the [Best-in-Slot](/jobs/tanks/paladin/best-in-slot)
      page)
  - question: How do the 6.4 changes affect the rotation?
    answer:
      You can now also hold Atonements for Fight or Flight like we could do
...
> _Why is Circle of Scorn used immediately in the opener?_
...
> _Can I use Fight or Flight after Riot Blade to make it easier to fit both Goring Blades?_
...
> _Should I save oGCDs for Fight or Flight?_
...
> _Should I keep Goring Blade up at all times?_
...
> _I lost uptime/made a mistake. How can I recover the rotation as efficiently as possible?_
...
> _Why can't I fit 11 GCDs in Fight or Flight?_
...
> _I'm disengaging from the boss, should I use Shield Lob?_
...
> _Should I be using Clemency to help my healers?_
...
> _How do Cover, Divine Veil, and Passage of Arms work?_
